...
import { RollingEnergyBalanceInfoModal } from './modals/info/RollingEnergyBalanceInfoModal';
...
export const EnergyMapCalculator = () => {
  ...
  const rollingEnergyBalanceInfoModal = useAnimatedModal();
  ...
  const handleCreateFoodFavourite = useCallback(
    (foodEntry, sourceFood) => {
      ...
      // - 'cloud'/'openfoodfacts' for cached online foods
  ...
  return (
    ...
    >
      ...
      <div className="max-w-6xl mx-auto space-y-6">
        ...
        <div className="relative">
          ...
          >
            ...
            />
            {/* Pure layout row: each slide positions itself with its own wrapped
                transform (written imperatively by useSwipeableScreens), so the
                row is never transformed and its height still tracks the tallest
                screen while the carousel loops in both directions. */}
      ...
      <RollingEnergyBalanceInfoModal
        isOpen={rollingEnergyBalanceInfoModal.isOpen}
        isClosing={rollingEnergyBalanceInfoModal.isClosing}
        onClose={rollingEnergyBalanceInfoModal.requestClose}
      />
