...
const getTagClasses = (tagId, isSelected) => {
  const colorMap = {
    protein: isSelected
      ? 'bg-accent-red/30 text-accent-red border-accent-red/50'
      : 'bg-surface-highlight/60 text-muted border-border',
    carbs: isSelected
      ? 'bg-accent-amber/30 text-accent-amber border-accent-amber/50'
      : 'bg-surface-highlight/60 text-muted border-border',
    vegetables: isSelected
      ? 'bg-accent-green/30 text-accent-green border-accent-green/50'
      : 'bg-surface-highlight/60 text-muted border-border',
    fats: isSelected
      ? 'bg-accent-yellow/30 text-accent-yellow border-accent-yellow/50'
      : 'bg-surface-highlight/60 text-muted border-border',
    supplements: isSelected
      ? 'bg-accent-purple/30 text-accent-purple border-accent-purple/50'
      : 'bg-surface-highlight/60 text-muted border-border',
  };
  return (
    colorMap[tagId] ||
