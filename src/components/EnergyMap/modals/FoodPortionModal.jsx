...
export const FoodPortionModal = ({
  ...
  return (
    ...
    >
      {/* Header */}
      <div className="mb-4">
        <div className="bg-surface-highlight/50 border border-border/80 rounded-lg p-3">
            ...
            <div className="flex-1 min-w-0">
              ...
              <div className="flex items-center gap-2 mt-1 flex-wrap">
                ...
                {selectedFood.subcategory && (
                  <span className="text-xs px-2 py-0.5 bg-surface-highlight/90/40 text-foreground/80 rounded capitalize">
          ...
          {hasCustomPortions ? (
            <div className="relative">
              <select
                ...
                className="bg-surface-highlight/50 border border-border/80 rounded px-3 py-1.5 pr-8 text-muted text-xs uppercase tracking-wide appearance-none focus:outline-none focus:ring-1 focus:ring-blue-400 cursor-pointer md:hover:bg-surface-highlight transition-all"
              >
      ...
      {nutrition && (
        <div className="bg-surface-highlight/50 border border-border/80 rounded-lg p-4 mb-6 shadow-lg shadow-background/20">
            ...
            <button
              ...
              className={`w-10 h-10 ml-1 border rounded-lg font-medium transition-all flex items-center justify-center press-feedback focus-ring ${
                isCurrentlyFavourited
                  ...
                  : 'bg-indigo-600 md:hover:bg-indigo-500 border-indigo-600/50 text-white disabled:bg-surface-highlight/90/20 disabled:border-border/80/50 disabled:cursor-not-allowed disabled:text-muted'
              }`}
            >
              <Heart
                size={20}
