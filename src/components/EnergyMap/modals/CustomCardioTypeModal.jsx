      ...
      >
            ...
            <div>
              ...
              <div className="relative">
                ...
                <button
                  ...
                  className="absolute top-1/2 -translate-y-1/2 right-2 inline-flex h-9 w-9 items-center justify-center rounded-md bg-surface-highlight/90/80 md:hover:bg-surface-highlight/80 text-foreground transition focus:outline-none focus:ring-2 focus:ring-blue-400 focus:ring-offset-2 focus:ring-offset-surface focus-ring pressable"
            ...
            <div>
              ...
              <div className="relative">
                ...
                <button
                  ...
                  className="absolute top-1/2 -translate-y-1/2 right-2 inline-flex h-9 w-9 items-center justify-center rounded-md bg-surface-highlight/90/80 hover:bg-surface-highlight/80 text-foreground transition focus:outline-none focus:ring-2 focus:ring-blue-400 focus:ring-offset-2 focus:ring-offset-surface"
        ...
        <div className="flex gap-3 mt-6">
          <button
            onClick={onCancel}
            type="button"
            className="flex-1 bg-surface-highlight active:bg-surface-highlight/90 text-foreground px-6 py-3 rounded-lg transition-all active:scale-95 font-medium"
          >
            Cancel
          </button>
          <button
