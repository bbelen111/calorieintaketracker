        ...
        return (
          <button
            ...
            className={`p-4 rounded-xl border-2 transition-all active:scale-[0.98] text-left ${
              isActive ? `${goal.color} border-white text-white shadow-lg` : 'bg-slate-700 border-slate-600 text-slate-300'
            }`}
            type="button"
          >
            <div className="flex items-center gap-4">
              ...
              <div className="flex-1">
                ...
                {goal.warning && (
                  <p className="text-xs opacity-75 mt-2 line-clamp-2">{goal.warning}</p>
                )}
              </div>
              {isActive && (
