          ...
          <div className="flex items-start justify-between gap-3">
            ...
            {onCreateCustomCardioType && (
              <button
                ...
                className="p-2 rounded-lg border border-border/80 bg-surface text-foreground/60 hover:border-indigo-400 hover:text-foreground transition-colors"
                ...
                <button
                  ...
                  className={`relative w-full text-left p-4 rounded-xl border-2 transition-all active:scale-[0.98] flex flex-col gap-2 focus-ring ${
                    isActive
                      ...
                      : 'bg-surface-highlight border-border/80 text-foreground/60 md:hover:border-blue-400'
                  }`}
                  role="listitem"
                >
