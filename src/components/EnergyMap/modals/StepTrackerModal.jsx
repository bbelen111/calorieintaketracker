            ...
            <div className="flex items-center justify-between gap-2 flex-wrap">
              ...
              <div className="relative" ref={timeframeDropdownRef}>
                ...
                {isTimeframeDropdownOpen && (
                  <div className="absolute right-0 top-full mt-1 bg-surface-highlight border border-border rounded-md shadow-lg z-10 min-w-[120px]">
                    {[
                      ...
                      <button
                        ...
                        className={`w-full px-4 py-2 text-left text-sm font-medium transition-colors md:hover:bg-surface first:rounded-t-md last:rounded-b-md ${
                                ...
                                return (
                                  <g key={idx}>
                                    ...
                                    <text
                                      ...
                                      y={textY}
                                      textAnchor="middle"
                                      className="fill-[rgb(var(--muted)/1)] text-[10px] font-semibold"
                                    >
                                    ...
                                    <text
                                      ...
                                      y={textY + 11}
                                      textAnchor="middle"
                                      className="fill-[rgb(var(--muted)/0.7)] text-[8px]"
                                    >
                                      avg
                                    </text>
                                  </g>
