...
export const WeightTrackerModal = ({
  ...
  const [, setActivePageIndex] = useState(-1); // -1 = auto-last
  ...
  const trendVisual7d = useMemo(
    () => getGoalAlignedStyle(trend7d, selectedGoal, 'weight'),
  ...
  const goalAlignment7d = useMemo(
    () => getGoalAlignmentText(trend7d.weeklyRate, selectedGoal, 'weight'),
  ...
  const allPoints7d = useMemo(() => {
    ...
    return buildTaggedChartSlots({
      ...
      minValue: globalChartData.minWeight,
  ...
  const allPoints12m = useMemo(() => {
    ...
    return months
      .map((m, i) => {
        ...
        const x = PAD + i * STEP;
        const norm =
          (m.avg - globalChartData.minWeight) / globalChartData.range;
  ...
  const weeklyRate7dDisplay = formatWeeklyRate(trend7d.weeklyRate, 'weight');

  const weeklyRateDisplay = formatWeeklyRate(trend.weeklyRate, 'weight');
  ...
  const renderContinuousChart = (
    ...
    const gradId = `areaGradient-w-${gradIdSuffix}`;
            ...
            {viewMode === '7d' ? (
              <>
                ...
                <div>
                  ...
                  <p
                    className={`${getTrendToneClass(trend7d, selectedGoal, 'weight')} font-semibold text-lg flex items-center gap-2`}
                  >
                ...
                <div>
                  ...
                  <p className="text-muted text-xs mt-1">
                    Goal: {getGoalWeeklyTarget(selectedGoal, 'weight')}
                  </p>
                </div>
              </>
            ) : (
                ...
                {viewMode === '30d' && (
                  <>
                    ...
                    <div>
                      ...
                      <p
                        className={`${getTrendToneClass(trend, selectedGoal, 'weight')} font-semibold text-lg flex items-center gap-2`}
                      >
