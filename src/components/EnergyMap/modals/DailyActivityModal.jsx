  ...
  return (
    ...
    >
      <div className="flex items-center justify-between mb-4 md:mb-6">
        <h3 className="text-white font-bold text-xl md:text-2xl">Daily Activity Presets</h3>
      </div>

      <p className="text-slate-300 text-sm mb-4">
        Configure the non-exercise (NEAT) calories that sit on top of your BMR. These presets cover incidental
        movement outside of intentional training, cardio, or tracked steps and are separated for training and rest days.
      </p>
      ...
      <div className="space-y-3 md:space-y-4">
        {['training', 'rest'].map((day) => {
          ...
          const multiplier = multipliers[day] ?? DEFAULT_ACTIVITY_MULTIPLIERS[day];
          ...
          return (
            ...
            >
              ...
              <div className="flex-1">
                ...
                <p className="text-xs opacity-75 mt-2">NEAT offset: {formatMultiplier(multiplier)}</p>
              </div>
