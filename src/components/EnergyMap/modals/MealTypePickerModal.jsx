        ...
        {MEAL_TYPE_ORDER.map((mealTypeId) => {
          ...
          return (
            <button
              ...
              className="w-full p-4 rounded-lg border-2 transition-all flex items-center gap-4 shadow-lg shadow-background/20 bg-surface-highlight border-border/80 md:hover:border-blue-500/50 focus-ring pressable-card"
              tabIndex={0}
            >
              ...
              {itemCount > 0 && (
                <span className="ml-2 text-xs text-muted font-medium px-2 py-1 rounded bg-surface/60">
